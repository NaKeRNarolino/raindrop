...
describe('test convertor', () => {
    ...
    it('test rgb cmyk', () => {
        ...
        expect(convertor.cmyk2rgb(64.9999999, 39.999999, 0, 21.568).map(i => utils.roundDecimal(i, 0))).toEqual([70, 120, 200]);
    });
    it('test rgb to hwb', () => {
    ...
    it('test xyz xyY', () => {
        ...
        expect(convertor.xyY2xyz(0.26327516, 0.28481248, 7.67).map(i => utils.roundDecimal(i, 2))).toEqual([7.09, 7.67, 12.17]);
    });
});
