type CommonColorTuple = [number, number, number];
type CommonColoraTuple = [number, number, number, number];
type CmykTuple = [number, number, number, number];
...
type DeltaEMode = DeltaEModeUpper | DeltaEModeLower;
type DeltaECmcSetting = {
    l: number;
    c: number;
};
type DeltaECie2000Setting = {
    kL: number;
    kC: number;
    kH: number;
};
type DeltaECie1994Setting = {
    kL: number;
    kC: number;
    kH: number;
    cate: 'graphic' | 'textiles';
};
type DeltaESetting = Partial<DeltaECmcSetting> | Partial<DeltaECie2000Setting> | Partial<DeltaECie1994Setting>;
/**
 ...
 */
declare function deltaE(color1: Color, color2: Color, mode?: DeltaEMode, setting?: DeltaESetting | {}): number;
 ...
 */
declare function colorsea(colorInput: CommonColorTuple | CommonColoraTuple | string, alpha?: number, config?: ColorConfig): Color;
